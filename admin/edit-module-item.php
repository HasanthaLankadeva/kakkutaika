                                ...
                                <div id="sortable">
                                    ...
                                    <?php $j++; endwhile; ?>
                                        <div id="filediv-<?=$k;?>" class="filediv">
                                            ...
                                            <div class="attachment-detail">
                                                <span>Title : </span><input type="text" name="file_data<?=$j;?>[]" value="<?php echo ($row !== false) ? $row['attTitle'] : ''; ?>" />
                                                <span>Title Description : </span><textarea name="file_data<?=$j;?>[]" value=""><?php echo ($row !== false) ? $row['attDes'] : ''; ?></textarea>
                                                <span>Alt Text : </span><input type="text" name="file_data<?=$j;?>[]" value="<?php echo ($row !== false) ? $row['alt'] : ''; ?>" />
                                            </div>
                                            <div class="remove-item" title="Remove"></div>
                                        </div>
                                </div>
